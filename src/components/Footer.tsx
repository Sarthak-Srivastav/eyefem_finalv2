    ...
    <>
      <footer className="bg-gradient-to-r from-gray-50 to-gray-100 pt-12 pb-8 border-t relative">
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <div>
              ...
              <p className="text-gray-600 mb-4">
                Providing specialized healthcare services in Eye Care and
                Gynecology.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <Link
                    to="/eyecare"
                    className="text-gray-600 hover:text-eyecare transition-colors"
                  >
                    Eye Care
                  </Link>
                </li>
                <li>
                  <Link
                    to="/gynecology"
                    className="text-gray-600 hover:text-gynecology transition-colors"
                  >
                    Gynecology
                  </Link>
                </li>
            ...
            <div>
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3 text-gray-600">
                  ...
                  <span>
                    25/11, East Patel Nagar, New Delhi
                    <br />
                    Delhi 110008
                  </span>
                </div>
                ...
                <div className="flex items-center gap-3 text-gray-600">
                  ...
                  <span>
                    ...
                    <br />
                    <a
                      href="mailto:drnishabhatnagar@gmail.com"
                      className="hover:text-primary transition-colors underline"
                    >
            ...
            <div>
              ...
              <p className="text-gray-600 mb-3">
                ...
                <br /> accessible, and
                <br />
                user-friendly digital presence.
              </p>
              <p className="text-gray-500 mb-3 text-sm font-medium">
                Website created by DevCubed
              </p>
              <Link
                to="/developers"
          ...
          <div
            className="border-t mt-8 pt-6 text-center text-gray-500"
            data-aos="fade-up"
          >
            <p>
              © {new Date().getFullYear()} Eyefem Healthcare. All rights
              reserved.
            </p>
